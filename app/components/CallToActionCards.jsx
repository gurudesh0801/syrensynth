...
export default function CallToActionCards() {
  ...
  return (
    <motion.div
      ref={ref}
      className="flex flex-col md:flex-row max-w-7xl mx-auto my-12 rounded-xl overflow-hidden shadow-lg"
    ...
    >
      ...
      >
        ...
        <p className="text-gray-700 mt-4 font-bold leading-relaxed space-y-3">
        ...
        <ul className="list-disc list-inside text-sm text-gray-700 mt-4 space-y-2">
          ...
          <li>
            Optimize your supply chain for unparalleled efficiency and cost
            savings.
          </li>
          <li>
            Accelerate your e-commerce growth with data-driven strategies.
          </li>
          <li>
            Provide strategic leadership to guide your marketing evolution.
          </li>
        </ul>

        <button className="mt-6 bg-[#0C1B3A] text-white px-5 py-2 rounded-md flex items-center gap-2 hover:bg-[#11224a] transition">
